...
class EtherspotWallet extends _i1.GeneratedContract {
  ...
  Future<String> addGuardian(
    ({_i2.EthereumAddress newGuardian}) args, {
    required _i1.Credentials credentials,
    _i1.Transaction? transaction,
  }) async {
  ...
  Future<String> executeBatch(
    ({
      List<_i2.EthereumAddress> dest,
      List<BigInt> value,
      List<_i3.Uint8List> func
    }) args, {
    required _i1.Credentials credentials,
    _i1.Transaction? transaction,
  }) async {
  ...
  Future<bool> isGuardian(
    ({_i2.EthereumAddress address}) args, {
    _i1.BlockNum? atBlock,
  }) async {
  ...
  Future<_i3.Uint8List> onERC721Received(
    ({
      _i2.EthereumAddress $param26,
      _i2.EthereumAddress $param27,
      BigInt $param28,
  ...
  Future<String> removeGuardian(
    ({_i2.EthereumAddress guardian}) args, {
    required _i1.Credentials credentials,
    _i1.Transaction? transaction,
  }) async {
  ...
  Future<void> tokensReceived(
    ({
      _i2.EthereumAddress $param33,
      _i2.EthereumAddress $param34,
      _i2.EthereumAddress $param35,
      BigInt $param36,
      _i3.Uint8List $param37,
      _i3.Uint8List $param38
    }) args, {
    _i1.BlockNum? atBlock,
  }) async {
...
class GetProposal {
  GetProposal(List<dynamic> response)
      : ownerProposed = (response[0] as _i2.EthereumAddress),
        approvalCount = (response[1] as BigInt),
        guardiansApproved =
            (response[2] as List<dynamic>).cast<_i2.EthereumAddress>(),
  ...
  final List<_i2.EthereumAddress> guardiansApproved;
...
class GuardianAdded {
  GuardianAdded(
    List<dynamic> response,
    this.event,
  ) : newGuardian = (response[0] as _i2.EthereumAddress);

  final _i2.EthereumAddress newGuardian;
...
class GuardianRemoved {
  GuardianRemoved(
    List<dynamic> response,
    this.event,
  ) : removedGuardian = (response[0] as _i2.EthereumAddress);
...
class OwnerAdded {
  OwnerAdded(
    List<dynamic> response,
    this.event,
  ) : newOwner = (response[0] as _i2.EthereumAddress);
...
class OwnerRemoved {
  OwnerRemoved(
    List<dynamic> response,
    this.event,
  ) : removedOwner = (response[0] as _i2.EthereumAddress);

  final _i2.EthereumAddress removedOwner;
...
class ProposalDiscarded {
  ProposalDiscarded(
    ...
    this.event,
        ...
        discardedBy = (response[1] as _i2.EthereumAddress);

  final BigInt proposalId;

  final _i2.EthereumAddress discardedBy;
...
class ProposalSubmitted {
  ProposalSubmitted(
    ...
    this.event,
        ...
        newOwnerProposed = (response[1] as _i2.EthereumAddress),
        proposer = (response[2] as _i2.EthereumAddress);

  final BigInt proposalId;

  final _i2.EthereumAddress newOwnerProposed;

  final _i2.EthereumAddress proposer;
