...
class EntryPoint extends _i1.GeneratedContract {
  ...
  Future<void> _validateSenderAndPaymaster(
    ({
      _i3.Uint8List initCode,
      _i2.EthereumAddress sender,
      _i3.Uint8List paymasterAndData
    }) args, {
  ...
  Future<BigInt> getNonce(
    ({_i2.EthereumAddress sender, BigInt key}) args, {
    _i1.BlockNum? atBlock,
  }) async {
  ...
  /// set, the function will be evaluated in the specified block. By default, the
  /// latest on-chain block will be used.
  Future<_i3.Uint8List> getUserOpHash(
    ({dynamic userOp}) args, {
    _i1.BlockNum? atBlock,
  }) async {
  ...
  Future<String> handleAggregatedOps(
    ({List<dynamic> opsPerAggregator, _i2.EthereumAddress beneficiary}) args, {
    required _i1.Credentials credentials,
    _i1.Transaction? transaction,
  }) async {
  ...
  Future<String> handleOps(
    ({List<dynamic> ops, _i2.EthereumAddress beneficiary}) args, {
    required _i1.Credentials credentials,
    _i1.Transaction? transaction,
  }) async {
  ...
  Future<String> innerHandleOp(
    ({_i3.Uint8List callData, dynamic opInfo, _i3.Uint8List context}) args, {
    required _i1.Credentials credentials,
    _i1.Transaction? transaction,
  }) async {
  ...
  Future<BigInt> nonceSequenceNumber(
    ({_i2.EthereumAddress $param20, BigInt $param21}) args, {
    _i1.BlockNum? atBlock,
  }) async {
  ...
  Future<String> withdrawStake(
    ({_i2.EthereumAddress withdrawAddress}) args, {
    required _i1.Credentials credentials,
    _i1.Transaction? transaction,
  }) async {
  ...
  Future<String> withdrawTo(
    ({_i2.EthereumAddress withdrawAddress, BigInt withdrawAmount}) args, {
    required _i1.Credentials credentials,
    _i1.Transaction? transaction,
  }) async {
...
class AccountDeployed {
  AccountDeployed(
    ...
    this.event,
  )   : userOpHash = (response[0] as _i3.Uint8List),
        sender = (response[1] as _i2.EthereumAddress),
        factory = (response[2] as _i2.EthereumAddress),
        paymaster = (response[3] as _i2.EthereumAddress);

  final _i3.Uint8List userOpHash;

  final _i2.EthereumAddress sender;

  final _i2.EthereumAddress factory;

  final _i2.EthereumAddress paymaster;
...
class Deposited {
  Deposited(
    List<dynamic> response,
    this.event,
  )   : account = (response[0] as _i2.EthereumAddress),
        totalDeposit = (response[1] as BigInt);

  final _i2.EthereumAddress account;
...
class SignatureAggregatorChanged {
  SignatureAggregatorChanged(
    List<dynamic> response,
    this.event,
  ) : aggregator = (response[0] as _i2.EthereumAddress);

  final _i2.EthereumAddress aggregator;
...
class StakeWithdrawn {
  StakeWithdrawn(
    ...
    this.event,
        ...
        withdrawAddress = (response[1] as _i2.EthereumAddress),
        amount = (response[2] as BigInt);

  final _i2.EthereumAddress account;

  final _i2.EthereumAddress withdrawAddress;
...
class UserOperationEvent {
  UserOperationEvent(
    ...
    this.event,
        ...
        sender = (response[1] as _i2.EthereumAddress),
        paymaster = (response[2] as _i2.EthereumAddress),
...
class UserOperationRevertReason {
  UserOperationRevertReason(
    ...
    this.event,
        ...
        revertReason = (response[3] as _i3.Uint8List);
