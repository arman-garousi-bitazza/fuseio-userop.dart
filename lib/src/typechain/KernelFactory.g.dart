...
class KernelFactory extends _i1.GeneratedContract {
  ...
  Future<String> createAccount(
    ({_i2.EthereumAddress validator, _i3.Uint8List data, BigInt index}) args, {
  ...
  /// set, the function will be evaluated in the specified block. By default, the
  /// latest on-chain block will be used.
  Future<_i2.EthereumAddress> getAccountAddress(
    ({_i2.EthereumAddress validator, _i3.Uint8List data, BigInt index}) args, {
  ...
  /// set, the function will be evaluated in the specified block. By default, the
  /// latest on-chain block will be used.
  Future<_i2.EthereumAddress> kernelTemplate({_i1.BlockNum? atBlock}) async {
  ...
  /// set, the function will be evaluated in the specified block. By default, the
  /// latest on-chain block will be used.
  Future<_i2.EthereumAddress> nextTemplate({_i1.BlockNum? atBlock}) async {
...
class AccountCreated {
  AccountCreated(
    ...
    this.event,
        ...
        validator = (response[1] as _i2.EthereumAddress),
        data = (response[2] as _i3.Uint8List),
